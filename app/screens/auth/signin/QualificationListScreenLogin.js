...
export default class QualificationListScreenLogin extends Component {
  constructor(args) {
    super(args);
  }
  ...
  onNextClick() {
    if (this.context.userData.qualification === undefined) {
      this.context.showToast("Please add qualification");
      return;
    }
