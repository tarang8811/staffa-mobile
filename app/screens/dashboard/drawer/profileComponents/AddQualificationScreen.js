...
export default class AddQualificationScreen extends Component {
  constructor(args) {
    super(args);
    this.state = {
  ...
  updateFirestoreData(screen, singleData) {
    ...
    var allData = [];
    if (this.context.userData.qualification) {
      allData = this.context.userData.qualification.data;
    }
    ...
    screen.context.updateUserData((user) => {
      console.log("onNextClick updateFirestoreData length 2 : " + this.context.userData.qualification.data.length);
          ...
          <View style={context.utilities.styles.root} ref={(ref) => { this.context = context; }}>
            <View style={{ marginTop: 10, flexDirection: 'row' }}>
              ...
              <View style={{ alignItems: 'center', flex: 1 }} >
                ...
                <Text style={context.utilities.styles.headerInfoTextStyle}>Add Qualification</Text>
              </View>
            </View>
